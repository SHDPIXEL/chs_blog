      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="font-serif text-4xl font-bold text-[#CC0033] mb-3">Blog</h1>
                    ...
                    <div className="max-w-3xl mx-auto">
                      <div className="flex items-center mb-6">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="text-sm">{formatDate(filteredArticles[0].createdAt.toString())}</span>
                        </div>
                        {filteredArticles[0].categories && filteredArticles[0].categories.length > 0 && (
                          <div className="flex items-center ml-4">
                            <Tag className="h-4 w-4 mr-1 text-[#CC0033]" />
                            <span className="text-sm">
                              {filteredArticles[0].categories.map((cat: any) => cat.name).join(', ')}
                            </span>
                          </div>
                        )}
                      </div>
                      
                      <h1 className="font-serif text-3xl font-bold text-[#333A3D] mb-6">{filteredArticles[0].title}</h1>
                      
                      <div 
                        className="prose prose-sm md:prose max-w-none font-sans"
                        dangerouslySetInnerHTML={{ __html: filteredArticles[0].content || '<p>Full content not available in preview mode.</p>' }}
                      />
                    </div>
                  </div>
                )}
