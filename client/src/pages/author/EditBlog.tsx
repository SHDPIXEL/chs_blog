...
const EditBlogPage: React.FC = () => {
  ...
  useEffect(() => {
    if (article) {
      ...
      const { article: articleData, categories: articleCategories, tags: articleTags, coAuthors } = article;
      
      // Map category IDs
      const categoryIds = articleCategories.map((category: Category) => category.id);
        ...
        <div className="py-6 px-4 sm:px-6 lg:px-8">
          <div className="bg-red-50 border-l-4 border-red-400 p-4 rounded">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-red-800">Error loading blog</h3>
                ...
                <Tabs defaultValue="content" className="space-y-4">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Alternative title for search engines (max 70 characters)
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                  ...
                  <TabsContent value="categories" className="space-y-6 px-4">
                    <div className="rounded-lg border p-4 bg-muted/30">
                      ...
                      <p className="text-sm text-muted-foreground mt-1 mb-2">
                        Organize your blog post with categories and tags for better discoverability
                      </p>
                    </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                                  ...
                                  <Checkbox
                                    ...
                                    onCheckedChange={(checked) => {
                                      ...
                                      if (checked) {
                                        ...
                                        if (!currentAuthors.includes(author.id)) {
                                          field.onChange([...currentAuthors, author.id]);
                                        }
                                      } else {
                                        // Remove author
                                        field.onChange(currentAuthors.filter((id) => id !== author.id));
                                      }
                                    }}
                                  />
                          ...
                          <FormDescription>
                            Select other authors who contributed to this blog post
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
